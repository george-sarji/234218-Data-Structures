...
int main()
{
    ...
    root = root->addIntersection(new int(20));
    root = root->addIntersection(new int(5));
    root = root->addIntersection(new int(4));
    root = root->addIntersection(new int(9));
    root = root->addIntersection(new int(22));
    root = root->addIntersection(new int(12));
    ...
    std::cout << std::endl;
    root = root->removeIntersection(new int(5));
    root->printInOrder();
    std::cout << std::endl;
    root = root->addIntersection(new int(5));
    ...
    root = root->removeIntersection(new int(12));
    root->printInOrder();
